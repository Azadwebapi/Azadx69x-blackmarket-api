...
const noPermissionMessage = "Oi bkcd! Tui admin na!😡";
...
onStart: async function ({ api, event, args }) {  
    const botAdmins = ['61578365162382'];
    ...
    if (!mention) return api.sendMessage("Kare bully korbo? mention koren!", event.threadID);  
